...
ProjectCollab is an experimental collaborative IDE built from the open-source
[Code - OSS](https://github.com/microsoft/vscode) codebase. `ProjectCollab` is
the current working name and can be changed before the first public release.

See [PROJECTCOLLAB.md](PROJECTCOLLAB.md) for the local development workflow,
upstream synchronization commands, and the rebranding checklist.

## Upstream: Visual Studio Code - Open Source ("Code - OSS")
